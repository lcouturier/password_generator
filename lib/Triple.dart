...
class Triple<T1, T2, T3> extends Pair<T1,T2> {
  ...
  factory Triple.fromList(List items) {
    ...
    return new Triple<T1, T2, T3>(items[0] as T1, items[1] as T2, items[2] as T3);
  }
  ...
  @override
  bool operator ==(o) => o is Triple && o.item1 == item1 && o.item2 == item2 && o.item3 == item3;    
  ...
  List toList({bool growable: false}) => new List.from([item1, item2, item3], growable: growable);
}